                                                ...
                                                <div className="content">
                                                    ...
                                                    <div className="tab-content">
                                                        <div className="tab-pane fade in active show" id="checkout-guest-form" role="tabpanel">
                                                            <form action="#" id="customer-form" className="js-customer-form" method="post">
                                                                <div>
                                                                    ...
                                                                    <div className="form-group row">
                                                                        <input className="form-control" name="email" type="email" placeholder="Phone" />
                                                                    </div>
                                                                    <div className="desc-password">
                                                                        <span className="font-weight-bold">Create an account</span>
                                                                        <span>(optional)</span>
                                                                        <br />
                                                                        <span className="text-muted">And save time on your next order!</span>
                                                                    </div>
                                                                    <div className="form-group row">
                                                                        <div className="input-group js-parent-focus">
                                                                            <input className="form-control js-child-focus" name="password" type="password" placeholder=" Password" />
                                                                        </div>
                                                                    </div>
                                                                    <div className="hidden-comment">
                                                                        <div className="form-group row">
                                                                            <input className="form-control" name="birthday" type="text" value="" placeholder=" Birthdate" />
                                                                        </div>
                                                                    </div>
                                                                    <div className="form-group row check-input">
                                                                        <span className="custom-checkbox d-inline-flex">
                                                                            <input className="check" name="optin" type="checkbox" value="1" />
                                                                            <label className="label-absolute">Receive offers from our partners</label>
                                                                        </span>
                                                                    </div>
                                                                    <div className="form-group row">
                                                                        <span className="custom-checkbox d-inline-flex check-input">
                                                                            <input className="check" name="newsletter" type="checkbox" value="1" />
                                                                ...
                                                                <div className="clearfix">
                                                                    <div className="row">
                                                                        ...
                                                                        <button className="continue btn btn-primary pull-xs-right" name="continue" data-link-action="register-new-customer" type="submit"
                                                                            value="1">
                                                                            Continue
                                                                        </button>
                                                                    </div>
                                                        ...
                                                        <div className="tab-pane fade" id="checkout-login-form" role="tabpanel">
                                                            <form id="login-form" action="#" method="post" className="customer-form">
                                                                <div>
                                                                    ...
                                                                    <div className="form-group row">
                                                                        <div className="input-group js-parent-focus">
                                                                            <input className="form-control js-child-focus js-visible-password" name="password" type="password" placeholder="Password" />
                                                                        </div>
                                                                    </div>
                                                                    <div className="row">
                                                                ...
                                                                <div className="clearfix">
                                                                    <div className="row">
                                                                        <button className="continue btn btn-primary pull-xs-right" name="continue" data-link-action="sign-in" type="submit" value="1">
                                                                            Continue
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="cart-summary">
                                                    <div className="cart-detailed-totals">
                                                        <div className="cart-summary-products">
                                                            <div className="summary-label">There are 3 item in your cart</div>
                                                        </div>
